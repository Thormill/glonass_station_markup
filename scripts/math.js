...
/*
* Функция для обрезания числа до 0.01
*/
function _floor(R){
...
/*
* Функция для нахождения радиуса распространения сигнала без помех
*/
function getIdealRadius() {
    return Math.pow(X() / Math.abs(Math.log(2) * Math.pow(10,-4)), 0.25);
}
/*
* Функция получения максимального и минимального радиуса от рельефа
*/
